...
*/
    ...
    const paragraphs = [
        "Airbnb Announces 'Community First' Initiative, Investing in Local Communities!" ,
        "Zomato Introduces 'Farm-to-Table' Initiative, Strengthening Its Commitment to Sustainable Food Sourcing.",
        "Google Maps Unveils 'Eco-Friendly Routes' Feature to Promote Sustainable Transportation"
    ];
